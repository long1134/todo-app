...
export const AutocompleteInviteUser: React.FC<AutocompleteInviteUserProps> = ({
	usersList,
	loading,
	setLoading,
}) => {
	...
	return (
		<Root>
			...
			>
				<InputWrapper
					sx={{ width: value.length > 0 ? "83%" : "100%" }}
					ref={setAnchorEl}
						...
						<li style={{ width: "96%" }} {...getOptionProps({ option, index })}>
							<Box sx={{ display: "flex", gap: 1 }}>
								...
								<Box>
									...
									<Typography variant="inherit">{option.status}</Typography>
								</Box>
							</Box>
						</li>
					))}
