			...
			<Box sx={{ flexGrow: 1 }}>
				<Grid container sx={{ height: "100vh" }}>
					<Grid
						...
						xs={12}
						md={5}
						sx={{ display: { xs: "none", md: "block" }, background: "#bceedf" }}
					>
						<Box sx={{ width: "80%", m: "auto", height: "30vh", pt: 7 }}>
							<Link to="/kanban">
								<img
									src="https://harnishdesign.net/demo/html/oxyy/images/logo-teal.png"
									alt="logo"
									height={34}
								/>
							</Link>
						...
						<Item bg="#bceedf">
							<Box sx={{ width: "80%", m: "auto" }}>
								<Typography sx={{ fontSize: "1.25rem !important", mb: 2 }}>
					...
					<Grid item xs={12} md={7}>
						...
						>
							<Box sx={{ float: "right", display: "flex" }}>
								...
								<Link to="/kanban">
									<Typography
										sx={{ textDecoration: "underline", color: "#20c997" }}
									>
										Sign Up
									</Typography>
								</Link>
						...
						<Item>
							...
							>
								...
								<Divider sx={{ fontSize: "0.975rem ", color: "#212529bf", mb: 2 }}>
									Or with Email
								</Divider>
